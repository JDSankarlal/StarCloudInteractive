...
namespace Input
{
	...
	public:
		...
		// Call this function to get if the Button is pressed. If true the button is pressed
		...
		// Call this function to get if the Button is stroked. if true the buton is pressed then released
	...
	private:
		...
		std::unordered_map<int,Button> *map = new std::unordered_map<int, Button>;
